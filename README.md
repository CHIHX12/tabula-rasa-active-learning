...
| Fig. 1 | the authors' own workflow illustration, not generated from data; its source ships with the manuscript, so it is neither included here nor regenerated by `make_figures.py` |
