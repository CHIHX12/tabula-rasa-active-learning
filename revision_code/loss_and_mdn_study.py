...
Answers, with numbers rather than assertion:
  * how were lambda_MSE = 0.10 and lambda_rec = 0.02 chosen, and do they matter?
                     -> full one-factor-at-a-time sensitivity sweep.
  * is the MSE term necessary, given the NLL already
                     contains it in some form?  -> lambda_MSE = 0 arm.
  * why a Gaussian mixture if only the mean and variance are
